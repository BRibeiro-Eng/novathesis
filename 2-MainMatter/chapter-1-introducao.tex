...
absorvem. Medir não basta. Esta dissertação parte do
...
nomeia usa-a como motivação para monitorizar. Estas contagens vêm de
uma extração assistida sem verificação humana por ocorrência
(Secção~\ref{sec:extracao-verificacao}). A contribuição não está, por isso,
...
retrospetiva. A
eletricidade fica sem diagnóstico diário. O que a reestimação anual
acomodou em cada ano não é mensurável sem o calendário operacional. Os
