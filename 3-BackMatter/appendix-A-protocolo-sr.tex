...
O protocolo foi registado no Open Science Framework a 24 de fevereiro de 2026, com o DOI \nolinkurl{10.17605/OSF.IO/TDW6C}. O registo não antecede a pesquisa nas bases: a calibração das expressões e a execução das pesquisas decorreram em fevereiro de 2026 e o protocolo registado já reporta os volumes recuperados (Secção~4.3 do protocolo). O registo antecede a recuperação dos textos integrais, a definição do instrumento de extração e toda a extração. A Tabela~\ref{tab:apA-cronologia} distingue os registos das etapas de execução que os delimitam.

\revisaotese{AP-A-01}{P1}{CONFIRMAR}
{Triagem antes ou depois do registo}
{A data de exportação do Rayyan (24 de fevereiro de 2026) coincide com a do registo. Confirmar se a triagem de título e resumo começou depois do depósito; se sim, acrescentar ``e a triagem'' à frase anterior. Confirmar também a data exata do depósito da emenda de abril (protocolo v2).}
...
\toprule
Data & Registo ou etapa & Identificação \\
\midrule
...
\toprule
ID & Configuração & Scopus & WoS & Decisão \\
\midrule
...
A Tabela~\ref{tab:apA-desvios} reúne os desvios ao protocolo e às emendas, registados ou não. Os três últimos não foram objeto de emenda: por decisão do autor, as alterações posteriores a 13 de setembro de 2026 declaram-se apenas nesta dissertação.
...
D7 & Cobertura humana do Corpus~B: 11 publicações às cegas e 31 com verificação dos campos que sustentam resultados (emenda de 2026-09-13). & Não executada. Os registos Stage~C têm verificação automática de ancoragem das citações ao texto, sem verificação humana por ocorrência. Cada proporção sobre o Corpus~B indica o denominador e este nível de verificação. & não registado \\
...
\revisaotese{AP-A-04}{P1}{CONFIRMAR}
{Desvio D6 e controlos da C-2.3 sem estado conhecido}
{D6: confirmar como foram re-decididos os 171 candidatos anulados antes do fecho de 12 de setembro; a redação atual só afirma o que os registos documentam. Confirmar ainda o estado de quatro controlos da C-2.3: auditoria por amostragem do nível~A (n=40, semente 44), reteste de 30 decisões do revisor, canário de instabilidade em 30 publicações e pesquisa terminológica nas exclusões de título e resumo com amostra de 50. Os não executados entram na tabela como D10 e seguintes.}
...
22 & Financiamento & Secção~\ref{sec:ambito} & Ver AP-A-05. \\
\end{xltabular}
}

\revisaotese{AP-A-05}{P1}{CONFIRMAR}
{Financiamento e conflitos de interesse (item 22)}
{Declarar se a revisão teve financiamento específico, o papel do estágio curricular na Galp e qualquer interesse decorrente de o caso empírico ser o local do estágio. Uma frase no §1.5 e a nota deste item. Os custos de computação da extração (Stage~C) foram suportados pelo autor? Confirmar.}
