...
\caption[Corpus B: características por estudo]{Corpus~B, estudo a estudo (39 registos cartografados). Nível mais forte entre os modelos de cada estudo. Fronteira (C5): exata, alocada, desvio reconhecido ou não reportada; reestimação (C6): regime declarado ou não; domínio (C7); fora da amostra (C8): validação com resultado reportado. Mec.\ e Adapt.: número de ocorrências. Valores com as decisões de verificação de 2026-09-17 aplicadas e os itens pendentes no valor original.}\label{tab:apB-corpus-b}\\
\toprule
