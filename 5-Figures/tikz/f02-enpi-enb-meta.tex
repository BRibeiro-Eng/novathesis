%% Figura: o conceito IDE/CER/meta e a fronteira entre o que a norma
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[x=1.2cm, y=1cm]
    ...
    \draw[corTinta, line width=.6pt, dash pattern=on 2pt off 1.6pt]
      (5.5,1.75) -- (5.5,4.80);
    \node[ntrot, anchor=south] at (2.80,4.92) {período de referência (CER)};
    ...
    \node[ntmini, text=corFG, anchor=north east] at (10.85,3.34)
      {CER: modelo estimado à esquerda};
    ...
    \node[ntmini, anchor=south east] at (10.9,4.22) {valor do IDE};
  ...
  \end{tikzpicture}
  \caption[O conceito IDE/CER/meta e a extensão de implementação]{O conceito
   IDE/CER/meta e a fronteira entre o que a norma desenha e o que a
