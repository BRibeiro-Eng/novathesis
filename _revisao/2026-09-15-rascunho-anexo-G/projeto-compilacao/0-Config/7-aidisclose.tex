...
% TODO: Activate only the items that apply to your actual AI usage
% Fill in when thesis is complete, before submission
...
% --- GAI tools used ---
% TODO: List GenAI tools actually used — fill in at thesis completion
% \AIDtoolsUsed{Tool1, Tool2}
