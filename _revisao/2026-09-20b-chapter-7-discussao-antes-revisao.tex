...
vapores; para comparar períodos, a relação anual muda de forma robusta no
vapor de 3~bar e, nos outros vetores, de forma que depende do método e de
...
não serve ao 24~bar, onde não há relação com a carga a estabilizar. Mas os
...
é que ele não se sustenta de forma uniforme: falha de forma robusta no vapor
...
posteriores. \textcite{Hamedi2019} e \textcite{Moghadasi2025} validam fora
da amostra, com partições que não respeitam a ordem do tempo, e
...
sensível ao limiar: com uma regra de três em cinco seriam três dos dezasseis
candidatos de mínimos quadrados aceites (os robustos não foram recontados
com essa regra); a regra de quatro em cinco estava pré-registada e não
...
três dos dezasseis candidatos de mínimos quadrados passariam. O intervalo de
