...
% [REV-2026-09-13][C8-01][P2][CONTEUDO] Fechar perguntas com resultados e limites, sem novo manifesto
...
% [REV-2026-09-13][C8-02][P2][ESTRUTURA] Trocar escada de complexidade por decisões guiadas pelo diagnóstico
...
% futuro numa tabela: falha observada -> opção -> dados adicionais ->
% comparador -> critério de sucesso. Primeiro calendário/eventos,
