...
% [REV-2026-09-13][C7-01][P2][ESTRUTURA] O capítulo mistura discussão, métodos e novos resultados
...
consta do Anexo~\ref{app:matematica}.

\section{Leitura integrada do diagnóstico}
\label{sec:leitura-integrada}

% [REV-2026-09-13][C7-02][P1][ARGUMENTO] A discussão amplia indevidamente o veredicto do diagnóstico
...
% [REV-2026-09-13][C7-03][P2][ARGUMENTO] Evitar a dicotomia fixa = deteta / adaptativa = esconde
...
% [REV-2026-09-13][F17][P2][FIGURA] Esquema central: referência, estado e monitor
% Após a tabela dos estimandos, inserir diagrama em três ramos:
% E_t,Q_t,Z_t -> referência fixa f_ref -> resíduo;
% resíduo -> modelo temporal -> estado estimado + inovação;
% resíduo/estado/inovação -> monitor explicitamente definido -> investigação.
...
% [REV-2026-09-13][C7-04][P2][NORMAS] Reformular a consequência normativa e discutir literatura
...
quatro rondas de revisão adversarial independente (Anexo~\ref{app:adversarial})
...
% [REV-2026-09-13][C7-05][P2][CRITERIOS] Não converter escolhas prudentes em regras universais
...
% [REV-2026-09-13][C7-06][P1][ACEITACAO] Compatibilidade por não-rejeição não valida uma banda
...
% Fonte: https://doi.org/10.1177/1948550617697177
% [/REV-2026-09-13]
...
% [REV-2026-09-13][C7-07][P1][ACEITACAO] A regra 4/5 precisa de justificação e avaliação conjunta
...
% [REV-2026-09-13][C7-18][P1][ESTIMANDO] O critério de aceitação tem de corresponder ao uso da baseline
...
% [REV-2026-09-13][C7-08][P2][MODELOS] Nomear a construção e tratar a quantílica anual como sensibilidade
...
% [REV-2026-09-13][C7-09][P1][ESTIMANDO] O candidato com AR muda a previsão; o ganho tem de corresponder
...
% [/REV-2026-09-13]
% [REV-2026-09-13][F18][P2][FIGURA] Matriz de decisão por candidato e por par anual
...
final e ficam registadas no Anexo~\ref{app:adversarial}.
...
% [REV-2026-09-13][C7-10][P2][POPULACAO] A interseção de 876 dias altera a população de interesse
...
% [REV-2026-09-13][F19][P2][FIGURA] Visualizar quanto sinal cada componente preserva
...
% [REV-2026-09-13][C7-11][P1][ALGEBRA] Reajustar não apaga universalmente o sinal de mudança
...
% [REV-2026-09-13][C7-12][P1][EVIDENCIA] Um lote inválido também não sustenta uma conclusão qualitativa
...
% [REV-2026-09-13][C7-14][P1][SIMULACAO] Tornar o gerador e a calibração de falsos sinais comparáveis
...
% [REV-2026-09-13][C7-15][P2][SIMULACAO] O gerador linear favorece a comparação pontual adotada
...
% [REV-2026-09-13][F20][P2][FIGURA] Curvas de deteção e atraso sob o mesmo falso sinal
...
% [REV-2026-09-13][C7-16][P2][SIMULACAO] Exemplos simulados não são teoremas universais
% Dar médias/tendências das séries independentes e distribuição de R²
% em várias réplicas; R² acumulado alto nesta realização não torna toda
...
% [REV-2026-09-13][F21][P3][FIGURA] Protótipo da ficha e diagrama de estados
...
% Uma segunda faixa representa operação -> investigar -> suspender/
% recalibrar -> verificar, com gatilhos e responsável; separar eventos
...
% [REV-2026-09-13][C7-13][P1][INTERPRETACAO] Cobertura e taxa de excursões são complementares
...
% [REV-2026-09-13][C7-17][P2][LIMITACOES] Corrigir contradições internas e preservar o alcance real
