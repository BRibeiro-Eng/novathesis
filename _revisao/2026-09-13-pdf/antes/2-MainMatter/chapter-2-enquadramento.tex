...
% [REV-2026-09-13][C2-01][P2][ESTRUTURA] Dar base de engenharia ao argumento estatístico
...
% Opção recomendada: processo/fronteiras -> conceitos -> normas ->
...
% [REV-2026-09-13][C2-02][P1][NORMAS] Edição histórica versus enquadramento atual
...
% Fonte verificada: https://www.iso.org/standard/79367.html
% [/REV-2026-09-13]
...
% [REV-2026-09-13][C2-03][P1][ESTATISTICA] R² não é um teste com pressuposto de normalidade
% Corrigir o ponto (iii): R² é uma estatística descritiva calculável sem
...
% não partilham todas elas. O argumento defensável é que R² e significância
...
% [REV-2026-09-13][C2-04][P1][NORMAS] Adequação normativa não se reduz à existência do instrumento
...
% [REV-2026-09-13][C2-05][P2][ESTRUTURA] Fundir passagens repetidas e separar texto normativo de interpretação
...
% [REV-2026-09-13][C2-06][P2][FONTES] Comparar vias e edições sem extrapolar os limiares
...
% da tabela. A recomendação R² >= 0,75 do IPMVP aparece apoiada numa fonte
...
% [REV-2026-09-13][F02][P2][FIGURA] Quadro físico de mecanismos e variáveis observáveis
...
% [REV-2026-09-13][F03][P2][FIGURA] Diagrama de processo e fronteira energética da CDU
% Figura essencial, logo após apresentar a unidade: crude -> pré-aquecimento
% -> dessalgação -> forno -> coluna -> produtos, ajustado ao esquema real.
...
% [REV-2026-09-13][C2-07][P2][CONTEUDO] Contextualizar seleção da unidade e energia equivalente
