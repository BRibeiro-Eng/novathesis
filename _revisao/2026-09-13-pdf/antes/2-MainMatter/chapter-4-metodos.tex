...
% [REV-2026-09-13][C4-01][P2][ESTRUTURA] Separar método reproduzível da história do desenvolvimento
...
% [REV-2026-09-13][C4-02][P1][DADOS] Agregação diária e conversão energética precisam de equações
...
% energia = soma(massa_h x PCI_h) ou massa_diária x PCI_médio:
...
% [REV-2026-09-13][C4-03][P2][CONSISTENCIA] O inventário não fecha aritmeticamente
...
% [REV-2026-09-13][F06][P2][FIGURA] Arquitetura de dados com granularidade e proveniência
% Depois de apresentar as tabelas de factos, inserir um esquema com dois
% painéis: (a) historiador/balanços/relatórios -> agregação e conversão ->
% precedência por linha -> factos; (b) estrela simplificada energia/carga/
...
% [REV-2026-09-13][C4-04][P1][METROLOGIA] Consistência documental, reconciliação e exatidão física
...
% [REV-2026-09-13][C4-05][P1][DADOS] Imputação, zeros e seleção na variável resposta
...
% [REV-2026-09-13][C4-06][P2][ENERGIA] Escrever o balanço de conversão e justificar constantes
% Incluir equações e tabela unidades de entrada -> fator -> t GNE/d.
...
% Explicar eletricidade: E_eq = MWh x 860,4/(11 820 x 0,57), com unidades
...
% [REV-2026-09-13][C4-07][P1][CRONOLOGIA] Precisar o que acontece efetivamente em janeiro
...
% [REV-2026-09-13][C4-08][P2][INDICADORES] Excesso positivo não estima desperdício ou poupança
% Definir e_t = E_t - previsão e distinguir soma(e_t) de soma(max(e_t,0)).
...
% [REV-2026-09-13][C4-09][P2][INDICADORES] Delimitar o EII e as emissões derivados da plataforma
...
% [REV-2026-09-13][C4-10][P2][INFERENCIA] Definir população, alvo inferencial e limites de HAC/MBB
...
% [REV-2026-09-13][C4-11][P1][VALIDACAO] O alvo nominal de 95% não foi validado pelo teste a 90%
...
% [REV-2026-09-13][F07][P2][FIGURA] Linha temporal dos três desenhos de avaliação
% Inserir aqui, antes da demonstração: três faixas alinhadas em 2020--2026.
% (a) treino y -> teste y+1 nos cinco pares; (b) mesmos pares para comparar
% candidatos, com afinação interna; (c) referência 2020 -> aplicação
...
% declara disponibilidade de Q_t/covariáveis e dos resíduos passados,
...
% [REV-2026-09-13][C4-12][P2][REPRODUTIBILIDADE] Integridade não certifica correção científica
...
% número -> tabela -> corrida -> dados/versão; transferir detalhes de
