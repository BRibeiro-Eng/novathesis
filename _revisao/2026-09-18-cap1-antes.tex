...
{Atualizado a 2026-09-17. Texto completo nos Caps.~1--8, resumos e
Apêndices A--C. Falta: Apêndice~D; a redução do Apêndice~E ao que o corpo
cita; as figuras (caixas F); as caixas que pedem decisão ou confirmação do
autor (C2-08, C3-06, C3-08, C5-06, AP-A); e as caixas editoriais deixadas
para a revisão integral (C1-08, C2-05, C4-01, C4-10, C5-01, C7-01, C3-02,
C3-10). As caixas acionáveis de 2026-09-13 foram resolvidas no texto e
retiradas; o registo está em \texttt{\_revisao/}.}%
% [/REV-2026-09-17]
...
relatam sobretudo sintomas no modelo e raramente a causa física: em 90 das
132 ocorrências de efeito extraídas não se nomeia nenhuma causa, e a
incrustação que a orientação industrial identificou de imediato aparece
uma vez, como motivação e não como limite do modelo. Estas contagens vêm de
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}p{1.7cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}p{3.1cm}@{}}
    ...
    Revisão, SQ2--SQ3 & Que mecanismos tornam os modelos inadequados, e que adaptações se propõem? & Síntese do Corpus~B (Secção~\ref{sec:corpus-b}) & respondida; verificação por modelo, decisões pendentes \\
    Revisão, SQ4 & As recomendações são aplicáveis numa refinaria? & --- & retirada (Apêndice~\ref{app:protocolo-sr}, D8) \\
    \bottomrule
  \end{tabularx}
\end{table}
%% Tabela 1.1: SQ2--SQ3 atualizada a 2026-09-17; retirar "decisões pendentes" quando a caixa C3-06 fechar.
