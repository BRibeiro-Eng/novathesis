...
%% 2026-09-21: o cruzamento norma x protocolo estava no Capitulo 3 como
%% heatmap. Foi retirado de la -- 24 celulas, seis a zero e doze com menos de
%% cinco publicacoes, e a cor nao codificava nada -- e passa a tabela aqui,
%% onde as celulas pequenas ficam disponiveis para verificacao sem pesarem no
%% argumento. O Capitulo 3 fica com as duas leituras que interessam em texto.
\fecho{A Tabela~\ref{tab:apB-norma-protocolo} dá o cruzamento completo entre o
enquadramento normativo e o protocolo de medição e verificação, que a
Secção~\ref{sec:corpus-a} cita em duas leituras: as 173 em 191 e o par de
proporções. Está aqui, e não no capítulo, porque metade das células tem menos
de cinco publicações e não sustenta leitura própria.}

{\footnotesize
\ntzebra
\begin{xltabular}{\linewidth}{@{}>{\raggedright\arraybackslash}X rrrrrr@{}}
\caption[Norma de gestão e protocolo de medição e verificação]{\fecho{Norma de
gestão e protocolo de medição e verificação invocados nas 331 publicações do
Corpus~A. Uma publicação entra em cada coluna de protocolo que nomeia, pelo
que as linhas não somam o total da publicação; as colunas do IPMVP, da ASHRAE
Guideline~14 e do SEP~M\&V batem certo com as contagens da
Secção~\ref{sec:corpus-a} (12, nove e sete). A codificação descreve o que o
artigo invoca, não a certificação da organização nem a conformidade do
modelo.}}\label{tab:apB-norma-protocolo}\\
\hiderowcolors
\toprule
\textbf{Norma invocada} & \textbf{Nenhum} & \textbf{IPMVP} & \textbf{ASHRAE 14} & \textbf{SEP M\&V} & \textbf{Outro} & \textbf{Por res.} \\
\midrule
\endfirsthead
\toprule
\textbf{Norma invocada} & \textbf{Nenhum} & \textbf{IPMVP} & \textbf{ASHRAE 14} & \textbf{SEP M\&V} & \textbf{Outro} & \textbf{Por res.} \\
...
\endlastfoot
\showrowcolors
    Família ISO 50001 & 173 & 8 & 4 & 5 & 2 & 4 \\
    Outra norma nomeada & 1 & 0 & 0 & 0 & 0 & 0 \\
    Nenhuma norma & 59 & 2 & 3 & 0 & 2 & 2 \\
    Por resolver ou sem extração & 16 & 2 & 2 & 2 & 2 & 54 \\
\end{xltabular}
}
