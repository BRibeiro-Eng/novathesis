...
mecanismo descrito no Capítulo~\ref{cha:diagnostico}: sobre o período usado
...
covariáveis de referência), ruído autorregressivo de primeira ordem, $\varepsilon_t = \rho\,\varepsilon_{t-1} + \sigma\sqrt{1-\rho^2}\,z_t$
