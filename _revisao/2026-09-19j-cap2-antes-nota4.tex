...
\novo{Quarta frente, e a que dispensa qualquer transposição entre setores:
\emph{critérios quantitativos em quadros aplicáveis a processo contínuo}. A
objeção de que os limiares anteriores nasceram no domínio dos edifícios ---
que se mantém válida quanto aos números --- não salva a tese da
inevitabilidade, porque há dois quadros que fixam critérios quantitativos fora
desse domínio, e um deles é direito vinculativo sobre a própria instalação em
estudo.}

\novo{O Regulamento de Execução (UE) 2018/2066, que rege a monitorização e a
comunicação de emissões no regime europeu de comércio de licenças, define a
incerteza como um intervalo de confiança a $95\,\%$ em torno do valor médio
(artigo~3.º, n.º~6) e fixa, no Anexo~II, incertezas máximas admissíveis por
nível de exatidão, com um bloco dedicado à refinação de petróleo: de
$\pm10\,\%$ a $\pm2{,}5\,\%$, do nível~1 ao nível~4, para a regeneração de
catalisador de \emph{cracking}, e de $\pm7{,}5\,\%$ a $\pm1{,}5\,\%$ para os
fluxos-fonte de combustível. O artigo~26.º obriga o operador a aplicar o nível
mais elevado do Anexo~II, admitindo descida apenas mediante prova de
inviabilidade técnica ou de custos desproporcionados --- e o artigo~18.º chega
a quantificar o teste de desproporção, com um preço de referência por licença.
O artigo~28.º, n.º~2, exige que a avaliação de incerteza seja entregue com o
plano de monitorização~\cite{MRR_2018}. A verificação independente tem, por
sua vez, um limiar de materialidade declarado: $5\,\%$ para instalações das
categorias A e B e $2\,\%$ para as da categoria~C~\cite[artigo~23.º]{AVR_2018}.
O regime aplica-se à refinação de petróleo sem limiar de
capacidade~\cite[Anexo~I]{ETS_Directive_2003}.}

\novo{A comparação que daqui resulta é interna à instalação. Na mesma
refinaria e a partir, em boa medida, das mesmas medições de combustível, o
número de carbono está sujeito a uma incerteza máxima declarada, a um nível de
confiança fixado, a uma avaliação documentada e a uma materialidade de
verificação; o número de energia derivado desses dados não está sujeito a
nenhum dos quatro. A assimetria não opõe edifícios a processo contínuo: opõe
...
instalação~\cite[p.~7]{Therkelsen2016}. O protocolo não é marginal na
literatura do domínio: é invocado por sete das publicações do corpus da
revisão (Capítulo~\ref{cha:revisao}). Os números em si não são o ponto ---
são de ajuste e de significância, não de desempenho fora do treino, de
calibração ou de deteção, que é o que o Capítulo~\ref{cha:metodos} adota. O
...
analisadas}.\footnote{\novo{A ISO~50047:2016, que trata a determinação de
poupanças de energia em organizações e integra a mesma série, não foi
consultada: o único excerto público acessível é o do projeto que lhe deu
origem (ISO/DIS~17747) e cobre apenas até à cláusula~5.1.1. O seu índice
anuncia uma cláusula~7.4, \enquote{Acceptable Uncertainty Criteria}, cujo
conteúdo não foi possível verificar; regista-se com as restantes limitações de
acesso documental (Secção~\ref{sec:limitacoes}). No excerto acessível, o
registo é integralmente de recomendação, os anexos são todos informativos e o
âmbito remete explicitamente os métodos de M\&V para a
...
\begin{table}[htbp]
  \centering\footnotesize
  \caption[Quadros aplicáveis a processo contínuo quanto a critérios quantitativos]{\novo{Quadros aplicáveis a processo contínuo, quanto a critérios quantitativos. Nenhum é um protocolo de validação de modelos de \emph{baseline} energética: o primeiro fixa incerteza de medição para efeitos de carbono, o segundo fixa ajuste e significância, o terceiro fixa desempenho relativo.}}
  \label{tab:comparadores-industriais}
  \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{3.1cm} X X X@{}}
    ...
    \midrule
    \novo{Reg. (UE) 2018/2066 e 2018/2067 (CELE)} & \novo{Incerteza da medição de fluxos-fonte para emissões de GEE} & \novo{Incertezas máximas por nível ($\pm1{,}5$ a $\pm7{,}5\,\%$ em combustíveis; $\pm2{,}5$ a $\pm10\,\%$ na regeneração de catalisador), a $95\,\%$ de confiança; materialidade de verificação de $5\,\%$ ou $2\,\%$} & \novo{Direito da União, vinculativo; aplica-se à instalação em estudo} \\
    \addlinespace
