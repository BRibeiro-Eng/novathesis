...
na tabela de parâmetros. A diferença entre os dois cálculos é a covariância
...
\bottomrule
\endlastfoot
    Desempenho preditivo (E2) & média das diferenças diárias de perda absoluta, modelo $-$ nulo, no ano de aplicação & dia; 5 pares & média do ano de treino (primário); mesmo dia do ano anterior e média móvel de 30 dias (secundários) & MBB sobre a série de diferenças; sensibilidade a blocos de 7, 14, 30, 60 e 90 dias; por contraste, sem correção & confirmatório; critério C1 do gate \\
    \addlinespace
...
muda a meio do ano de aplicação, a série reamostrada já não tem um valor
esperado único e o intervalo deixa de apontar a uma quantidade fixa; é o
...
anuais, e um comprimento declarado que exceda a extensão civil da amostra é
...
nada mudou. A referência congelada lê a mesma perda de cobertura no ano
