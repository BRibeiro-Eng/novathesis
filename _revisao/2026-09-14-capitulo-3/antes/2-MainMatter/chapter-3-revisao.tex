...
{Fechar a revisão com estado verificável}
...
Fonte verificada: \url{https://www.prisma-statement.org/scoping}}%
% [/REV-2026-09-13]
...
{Tornar a revisão reprodutível e limitar o viés do corpus ISO}
...
{Fluxo PRISMA com a formação dos dois corpora}
...
{Contagem bibliométrica não demonstra adequação metodológica}
