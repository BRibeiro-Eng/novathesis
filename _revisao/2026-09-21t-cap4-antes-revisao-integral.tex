...
{Feito a 2026-09-18: as definições dos três estimandos, da classe de
candidatos e do critério de aceitação vieram do Cap. 7 para o fim da
Secção~\ref{sec:protocolo-baselines}. Fica para a revisão integral: mover
inventários extensos, erros de implementação, contagens de testes e
pormenores de publicação de corridas para apêndices, conservando no corpo
só as decisões que alteram o estimando ou a validade dos resultados.}%
% [/REV-2026-09-13]
...
subcontado sem marca, e um dia sem nenhum valor passa a zero no canal de
\emph{tags}. Nos combustíveis com poder calorífico medido, a energia diária
...
de utilidades (84), eletricidade (708), ficheiros de apoio da eletricidade
(53), crudes (434), densidades (426), planos de fabrico (2\,076) --- com o MD5 de cada ficheiro num manifesto e
...
cópia e a verificação). A versão congelada é a cópia de 31 de julho; os
planos de fabrico não entram no cálculo da energia, da carga nem das
\emph{baselines}.
...
canal de \emph{tags} face ao balanço vai de $-11\%$ em 2020 a $0\%$ em 2023;
...
um dia sem valor no canal de \emph{tags} passa a zero nesse canal. Os dias com
...
\endlastfoot
    ...
    \addlinespace
    Calibração (E4) & fração de dias do ano de aplicação dentro da banda $\pm2\hat\sigma$ do ano de treino & dia; 5 pares & nominal 0,9545 & MBB sobre o indicador diário; sensibilidade a blocos de 14, 30 e 60 dias; por contraste & confirmatório; critério C2 do gate \\
    \addlinespace
...
de produzir números diferentes em silêncio. \revisto{A identidade das observações selecionadas pela replicação do método de produção é guardada como \emph{fingerprints} de referência; não foi comparada com uma lista independente de dias exportada do Power BI.}
