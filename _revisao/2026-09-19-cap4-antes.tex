...
medições são ajustadas para satisfazer balanços de massa e energia, e a
concordância entre canais não é prova de exatidão metrológica: dois canais
...
\bottomrule
\endlastfoot
    Poder preditivo (E2) & média das diferenças diárias de perda absoluta, modelo $-$ nulo, no ano de aplicação & dia; 5 pares & média do ano de treino (primário); mesmo dia do ano anterior e média móvel de 30 dias (secundários) & MBB sobre a série de diferenças; sensibilidade a blocos de 7, 14, 30, 60 e 90 dias; por contraste, sem correção & confirmatório; critério C1 do gate \\
    \addlinespace
