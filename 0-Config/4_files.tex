...
%-------------------------------------------------------------
% 2026-09-16: dedicatória cortada por decisão do autor. Basta descomentar para a repor.
...
% 2026-09-16: ordem final (A protocolo, B extração, C tabelas, D manual, E matemática).
% Dicionário e revisão adversarial retirados; esqueletos em 3-BackMatter/_arquivo.
\ntaddfile{appendix}{appendix-C-tabelas}
\ntaddfile{appendix}{appendix-D-manual}
\ntaddfile{appendix}{appendix-E-matematica}
