...
% 2026-09-16: ordem nova (A protocolo, B extração, C dicionário, D adversarial, E tabelas, F manual, G matemática).
\ntaddfile{appendix}{appendix-D-adversarial}
\ntaddfile{appendix}{appendix-E-tabelas}
\ntaddfile{appendix}{appendix-F-manual}
\ntaddfile{appendix}{appendix-G-matematica}
